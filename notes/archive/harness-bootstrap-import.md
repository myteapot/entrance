...
- `notes/harness/bootstrap/duet/SKILL.md`
- `notes/harness/bootstrap/duet/roles/arch.md`
- `notes/harness/bootstrap/duet/roles/dev.md`
- `notes/harness/bootstrap/duet/roles/agent.md`
- `notes/harness/bootstrap/nota/identity.md`
- `notes/harness/bootstrap/nota/rules.md`
- `notes/harness/bootstrap/README.md`
- `notes/harness/bootstrap/mapping.md`
...
- `notes/harness/` makes ownership explicit
...
| Old path | New path |
|---|---|
| `A:/.agents/duet/SKILL.md` | `notes/harness/bootstrap/duet/SKILL.md` |
| `A:/.agents/duet/roles/arch.md` | `notes/harness/bootstrap/duet/roles/arch.md` |
| `A:/.agents/duet/roles/dev.md` | `notes/harness/bootstrap/duet/roles/dev.md` |
| `A:/.agents/duet/roles/agent.md` | `notes/harness/bootstrap/duet/roles/agent.md` |
| `A:/.agents/nota/identity.md` | `notes/harness/bootstrap/nota/identity.md` |
| `A:/.agents/nota/rules.md` | `notes/harness/bootstrap/nota/rules.md` |
...
These do not belong under `notes/harness/bootstrap/`.
