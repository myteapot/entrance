...
- `entrance-os-arch.md`
  - foundation architecture signals now live across `notes/specs/top/machine.md`, `notes/specs/top/control.md`, `notes/specs/top/truth.md`, and their mounted cold docs
- `entrance-continuous-learning.md`
  - continuous-learning signals are now mainly carried by `notes/specs/top/3.1-learning-and-truth-system.md` and `notes/specs/cold/3.1-learning-truth-system/minimal_truth_plane.md`
