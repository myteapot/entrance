...
- `hosts/desktop/tauri/src/core/compiler/*`
- `hosts/desktop/tauri/src/core/nota/*`
- `hosts/desktop/tauri/src/core/event_bus.rs`
- `hosts/desktop/tauri/src/core/instance_manager.rs`
- `hosts/desktop/tauri/src/core/recovery.rs`
- `hosts/desktop/tauri/src/core/supervision.rs`
- `hosts/desktop/tauri/src/core/parallel_budget.rs`
- `hosts/desktop/tauri/src/core/system_heartbeat.rs`

Likely `core/services/`:

- `hosts/desktop/tauri/src/core/overview.rs`
- `hosts/desktop/tauri/src/core/landing.rs`
- parts of `hosts/desktop/tauri/src/plugins/forge/`
- parts of `hosts/desktop/tauri/src/plugins/launcher/`
- parts of `hosts/desktop/tauri/src/plugins/vault/`

Likely `core/infra/`:

- `hosts/desktop/tauri/src/core/data_store.rs`
- `hosts/desktop/tauri/src/core/config_store.rs`
- `hosts/desktop/tauri/src/core/logging.rs`
- `hosts/desktop/tauri/src/core/memory_import.rs`
...
- `hosts/desktop/tauri/src/cli/compiler_cli.rs`
- `hosts/desktop/tauri/src/cli/forge_cli.rs`
- `hosts/desktop/tauri/src/cli/issues_cli.rs`
- `hosts/desktop/tauri/src/cli/memory_cli.rs`
- `hosts/desktop/tauri/src/cli/nota_cli.rs`
- `hosts/desktop/tauri/src/cli/mcp_cli.rs`
- `hosts/desktop/tauri/src/core/mcp_server.rs`
...
- `hosts/desktop/tauri/src/main.rs`
- `hosts/desktop/tauri/src/commands/*`
- `hosts/desktop/tauri/src/core/window.rs`
- `hosts/desktop/tauri/src/core/theme.rs`
- `hosts/desktop/tauri/src/core/updater.rs`
- `hosts/desktop/tauri/src/core/hotkey.rs`
- `hosts/desktop/tauri/tauri.conf.json`
- `hosts/desktop/tauri/capabilities/*`
- `hosts/desktop/tauri/icons/*`
...
- `electron/dev.mjs`
- `hosts/desktop/tauri/src/cli/electron_bridge_cli.rs`
...
- reduce `hosts/desktop/tauri/src/lib.rs` to app assembly
- treat `hosts/desktop/tauri/src/commands/*` as Tauri bridge code
...
- move CLI from `hosts/desktop/tauri/src/cli/` to `surfaces/cli/`
