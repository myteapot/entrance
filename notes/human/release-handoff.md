...
- `hosts/release/reconciliation-batch-01.json`
- `hosts/release/reconciliation-batch-01-report.snapshot.json` (captured reference snapshot)
...
- `hosts/release/electron-smoke.mjs`
