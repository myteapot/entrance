...
Runtime continuity now resumes from two separate DB-backed read surfaces:

- `entrance nota checkpoints` for the active `v0` operating cut
- `entrance nota decisions` for longer-lived architectural direction
...
- keep long-term direction separate from the current `v0` operating cut
