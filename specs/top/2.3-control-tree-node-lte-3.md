...
- define the remaining node kinds and tree semantics below the compressed root
- define the relation between tree shape, routing, and parallel lanes
- define the minimal surface-density preset model and its orthogonality to engagement profiles
- decide whether the document/file naming should remain `Bt tree` or be normalized later
