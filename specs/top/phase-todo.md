...
- hold the active cross-trunk work queue for the current design and runtime consolidation phase
...
- the active hot root remains `README.md / machine.md / control.md / truth.md / phase-todo.md / pending.md`
- live runtime continuity is `DB-first` under `~/.entrance/data/entrance.db`
- external configuration is anchored at `~/.entrance/entrance.toml`
- `Dev` and `Agent` are bounded execution lanes, not peer continuation controllers
- semantic continuation policy remains runtime-governed and is still not fully human-configurable
