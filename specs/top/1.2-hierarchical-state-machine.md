...
- finalize the whole-system top graph in mounted cold form, then keep this doc as a short mount summary
- define the remaining packet-resolution and state-projection rules that are still missing from the cold graph
- define the minimal phase-projection rules for Human-facing hot surfaces
- define the relation between machine state, phase projection, and cadence protocol
