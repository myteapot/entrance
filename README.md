...
- MCP-native 产品化：当前只有本地 stdio tools/resources/prompts 和本地确认记录，还缺真实 MCP 客户端配置、身份/权限边界、协议兼容测试、远程连接器绑定和面向 human review 的交互设计。
