...
- 完整的 GitHub/Linear issue connector，包括真实 read-after-write、幂等 receipt、失败重试和本地/远端漂移校验；GitHub 目前只有受配置和 token gate 保护的 publish writer 切片。
