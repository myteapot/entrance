...
- 更完整的 loop dashboard：当前已有 selected issue Loop Dashboard 最小切片，但还缺按 round、packet/admission/evidence/verdict、retry lineage 和 blocker decision surface 组织的完整 drilldown。
