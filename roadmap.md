...
- Productize issue transition policy：当前已经有 kernel registry/report snapshot/audit 绑定和 execution-time transition admission receipt；还缺版本迁移、系统化状态机测试、Panel 操作后刷新、远端 issue 状态映射和更完整的 policy lifecycle。
